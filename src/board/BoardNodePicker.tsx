...
/** Picker to link a board sticky to a mindmap node — searches currently-open
 *  map tabs only (same scope as note/NodePicker.tsx, which this mirrors;
 *  duplicated rather than imported across the board/note domain boundary). */
export function BoardNodePicker({ onPick, onClose }: Props) {
