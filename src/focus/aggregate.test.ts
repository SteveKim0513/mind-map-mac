...
describe('focus aggregate', () => {
  ...
  it('focusDaysInWindow counts distinct focus days in the window only', () => {
    ...
    expect(focusDaysInWindow([S(NOW, 0, 2, 'a')], NOW, 7)).toBe(1); // a real sub-5m session still marks its day
