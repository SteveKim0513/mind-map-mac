  ...
  },
  {
    ...
    body: (
      <>
        ...
        <K k="연동" d="스티키 하나를 선택했을 때만 — 마인드맵 노드, 노트, 또는 외부 링크(URL)에 연결. 카드 안에 칩으로 표시되며 누르면 그 노드·노트로 이동하거나 링크를 새 창으로 열고, ×로 연결 해제. 연결된 노드·노트 쪽에도 '보드에서 참조됨' 칩이 뜨고, 누르면 이 보드로 돌아와 스티키를 바로 보여줌" />
