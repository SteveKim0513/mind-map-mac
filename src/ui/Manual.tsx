...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <K k="일정" d="노드를 일정으로 지정 — 날짜 · 시간 팝오버 + macOS 미리알림 동기화" />
        <K k="드래그" d="주 · 월 보기에서 일정을 다른 날짜 · 시각으로 끌어 옮기기 (미리알림도 함께)" />
        <K k="빈 칸 클릭" d="주간 시간표의 빈 곳을 눌러 그 시각에 바로 새 일정 만들기" />
  ...
  },
  {
    ...
    body: (
      <>
        <p className="man-lead">일정을 정한 노드에서 집중을 시작해 목표 · 과정 · 결과를 남깁니다.</p>
        <K k="집중" d="일정이 있는 노드에서 시작 (일정 팝오버 · 노드 메뉴) — 타이머와 작업 로그 노트" />
